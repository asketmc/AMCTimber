...
|---|---|---|---|---|---|---|
| `paper-1.20.6-java21-default` | Paper · MC 1.20.6 · Java 21 · defaults; no optional integrations | ✅ supported | ✅ verified | ❌ gap | ✅ verified | [current-main Paper smoke](https://github.com/asketmc/AMCTimber/actions/runs/29511517489)<br>[exact v1.0.9 pre-publication smoke](https://github.com/asketmc/AMCTimber/actions/runs/29467341360)<br>[post-release runtime workflow](../.github/workflows/post-release-runtime.yml)<br>[v1.0.9 post-release runtime receipt](../docs/evidence/configuration-matrix/v1.0.9-post-release-runtime.json) |
| `paper-1.21.11-java21-default` | Paper · MC 1.21.11 · Java 21 · defaults; no optional integrations | ✅ supported | ✅ verified | ❌ gap | ✅ verified | [current-main Paper smoke](https://github.com/asketmc/AMCTimber/actions/runs/29511517489)<br>[exact v1.0.9 pre-publication smoke](https://github.com/asketmc/AMCTimber/actions/runs/29467341360)<br>[post-release runtime workflow](../.github/workflows/post-release-runtime.yml)<br>[v1.0.9 post-release runtime receipt](../docs/evidence/configuration-matrix/v1.0.9-post-release-runtime.json) |
